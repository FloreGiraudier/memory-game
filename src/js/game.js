import { setNewVisibleCard, getVisibleCards, removeVisibleCards, isGameLost } from './localStorage.js'
...
const compareTurnedCards = () => {
    ...
    if (cards[0].fruit === cards[1].fruit) {
        ...
        var card1 = document.getElementById(cards[0].cardIndex);
        var card2 = document.getElementById(cards[1].cardIndex);
        winCard(card1);
        winCard(card2);
    }
    else {
